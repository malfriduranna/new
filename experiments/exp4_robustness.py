    ...
    save_metrics_json(
        {
            ...
            "rgb_resolution": {str(k): v for k, v in vid_results},
        },
        metrics_path,
    )

    plot_robustness_curves(
        {"HD-GCN noise sigma": hd_results, "VideoMAE resolution": vid_results},
        output_path=config.output.plots_dir / "exp4_robustness.png",
    )
